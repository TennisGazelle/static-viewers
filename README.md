...
The data is split into source-aligned JSON files rather than one giant graph fixture. The viewer currently merges the main leitmotif catalogue, all 116 numbered incidental motifs, every set-piece theme explicitly named in the catalogue's notable/sampling section, and the complete lettered Battle of Hoth set-piece case study. The set-piece section itself is a sampling rather than a claim to enumerate every cue-specific idea in the scores.
